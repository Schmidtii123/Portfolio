...
export default function Contact(){
    ...
    return(
      ...
      <img className="img_container velkommen_img"src="./emil_linkedin.png" alt="Mig(Emil Schmidt) der smiler med hænderne over kryds" />
        ...
        <a href=""><img className='some_img' src="./linkedin.png" alt="Linkedin logo" /></a>
      <a href=""><img className='some_img' src="./instagram.png" alt="Instagrams Logo" /></a>
      <a href=""><img className='some_img' src="./facebook.png" alt="Facebooks logo" /></a>
        </div>
        </section>
